    ...
    groups: [
      {
        ...
        rows: [
          ...
          { name: "Deluxe Manicure with Shellac", price: "€55" },
      ...
      },
      {
        ...
        rows: [
          { name: "Manicure with BIAB", price: "€50" },
          { name: "BIAB Overlay", price: "€45" },
          { name: "BIAB Refill", price: "€45" },
          { name: "BIAB + Shellac", price: "€55" },
    ...
    groups: [
      {
        ...
        rows: [
          ...
          { name: "Full Face + Mini Facial", price: "€64" },
